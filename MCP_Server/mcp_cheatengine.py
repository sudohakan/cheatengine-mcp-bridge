            ...
            if not self.handle:
                if not self.connect():
                    raise ConnectionError(
                        "Cheat Engine Bridge (v11/v99) is not running (Pipe not found)."
                    )
...
def get_symbol_address(symbol: str) -> str:
    ...
    return format_result(
        ce_client.send_command("get_symbol_address", {"symbol": symbol})
    )
...
def get_rtti_classname(address: str) -> str:
    ...
    return format_result(
        ce_client.send_command("get_rtti_classname", {"address": address})
    )
...
def read_memory(address: str, size: int = 256) -> str:
    ...
    return format_result(
        ce_client.send_command("read_memory", {"address": address, "size": size})
    )
...
def read_integer(address: str, type: str = "dword") -> str:
    ...
    return format_result(
        ce_client.send_command("read_integer", {"address": address, "type": type})
    )
...
def read_string(address: str, max_length: int = 256, wide: bool = False) -> str:
    ...
    return format_result(
        ce_client.send_command(
            "read_string", {"address": address, "max_length": max_length, "wide": wide}
        )
    )
...
def read_pointer(address: str, offsets: list[int] = None) -> str:
    ...
    if offsets:
        return format_result(
            ce_client.send_command(
                "read_pointer_chain", {"base": address, "offsets": offsets}
            )
        )
    else:
        return format_result(
            ce_client.send_command(
                "read_pointer_chain", {"base": address, "offsets": [0]}
            )
        )
...
def read_pointer_chain(base: str, offsets: list[int]) -> str:
    ...
    return format_result(
        ce_client.send_command("read_pointer_chain", {"base": base, "offsets": offsets})
    )
...
def checksum_memory(address: str, size: int) -> str:
    ...
    return format_result(
        ce_client.send_command("checksum_memory", {"address": address, "size": size})
    )
...
def scan_all(value: str, type: str = "exact", protection: str = "+W-C") -> str:
    ...
    return format_result(
        ce_client.send_command(
            "scan_all", {"value": value, "type": type, "protection": protection}
        )
    )
...
def next_scan(value: str, scan_type: str = "exact") -> str:
    ...
    return format_result(
        ce_client.send_command("next_scan", {"value": value, "scan_type": scan_type})
    )
...
def write_integer(address: str, value: int, type: str = "dword") -> str:
    ...
    return format_result(
        ce_client.send_command(
            "write_integer", {"address": address, "value": value, "type": type}
        )
    )
...
def write_memory(address: str, bytes: list[int]) -> str:
    ...
    return format_result(
        ce_client.send_command("write_memory", {"address": address, "bytes": bytes})
    )
...
def write_string(address: str, value: str, wide: bool = False) -> str:
    ...
    return format_result(
        ce_client.send_command(
            "write_string", {"address": address, "value": value, "wide": wide}
        )
    )
...
def aob_scan(pattern: str, protection: str = "+X", limit: int = 100) -> str:
    ...
    return format_result(
        ce_client.send_command(
            "aob_scan", {"pattern": pattern, "protection": protection, "limit": limit}
        )
    )
...
def search_string(string: str, wide: bool = False, limit: int = 100) -> str:
    ...
    return format_result(
        ce_client.send_command(
            "search_string", {"string": string, "wide": wide, "limit": limit}
        )
    )
...
def generate_signature(address: str) -> str:
    ...
    return format_result(
        ce_client.send_command("generate_signature", {"address": address})
    )
...
def enum_memory_regions_full(max: int = 500) -> str:
    ...
    return format_result(
        ce_client.send_command("enum_memory_regions_full", {"max": max})
    )
...
def disassemble(address: str, count: int = 20) -> str:
    ...
    return format_result(
        ce_client.send_command("disassemble", {"address": address, "count": count})
    )
...
def get_instruction_info(address: str) -> str:
    ...
    return format_result(
        ce_client.send_command("get_instruction_info", {"address": address})
    )
...
def find_function_boundaries(address: str, max_search: int = 4096) -> str:
    ...
    return format_result(
        ce_client.send_command(
            "find_function_boundaries", {"address": address, "max_search": max_search}
        )
    )
...
def analyze_function(address: str) -> str:
    ...
    return format_result(
        ce_client.send_command("analyze_function", {"address": address})
    )
...
def find_references(address: str, limit: int = 50) -> str:
    ...
    return format_result(
        ce_client.send_command("find_references", {"address": address, "limit": limit})
    )
...
def find_call_references(function_address: str, limit: int = 100) -> str:
    ...
    return format_result(
        ce_client.send_command(
            "find_call_references", {"address": function_address, "limit": limit}
        )
    )
...
def dissect_structure(address: str, size: int = 256) -> str:
    ...
    return format_result(
        ce_client.send_command("dissect_structure", {"address": address, "size": size})
    )
...
def set_data_breakpoint(
    address: str, id: str = None, access_type: str = "w", size: int = 4
) -> str:
    """Set a hardware data breakpoint (watchpoint). Types: 'r' (read), 'w' (write), 'rw' (access)."""
    return format_result(
        ce_client.send_command(
            "set_data_breakpoint",
            {"address": address, "id": id, "access_type": access_type, "size": size},
        )
    )
...
def get_breakpoint_hits(id: str = None, clear: bool = False) -> str:
    ...
    return format_result(
        ce_client.send_command("get_breakpoint_hits", {"id": id, "clear": clear})
    )
...
def get_physical_address(address: str) -> str:
    ...
    return format_result(
        ce_client.send_command("get_physical_address", {"address": address})
    )
...
def stop_dbvm_watch(address: str) -> str:
    ...
    return format_result(
        ce_client.send_command("stop_dbvm_watch", {"address": address})
    )
...
def poll_dbvm_watch(address: str, max_results: int = 1000) -> str:
    ...
    return format_result(
        ce_client.send_command(
            "poll_dbvm_watch", {"address": address, "max_results": max_results}
        )
    )
